      ...
      <section class="section wow fadeIn" data-wow-delay="0.3s">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            @component('components.text-block', ['icon' => 'fa-flag-checkered', 'textcolor' => 'indigo-text', 'title' => 'Última geração']) @endcomponent
            @component('components.text-block', ['icon' => 'fa-flag', 'textcolor' => 'orange-text', 'title' => 'Base tecnológica']) @endcomponent
            @component('components.text-block', ['icon' => 'fas fa-atom', 'textcolor' => 'purple-text', 'title' => 'Inteligência artificial']) @endcomponent
